...
from boss_agent.browser.detector import Detector
from boss_agent.browser.models import (
    BrowserError,
    BrowserState,
    InteractiveElementsData,
    TabInfo,
)
from boss_agent.browser.utils import (
    filter_elements,
    put_highlight_elements_on_screenshot,
    scale_b64_image,
)
from boss_agent.browser.utils import is_pdf_url

logger = logging.getLogger(__name__)

INTERACTIVE_ELEMENTS_JS_CODE = resources.read_text(
    "boss_agent.browser", "findVisibleInteractiveElements.js"
)
