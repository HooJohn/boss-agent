    ...
    <div className="container mx-auto p-4 h-full flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        <Select onValueChange={setReportType}>
          <SelectTrigger>
            <SelectValue placeholder="人事分析类型" />
          </SelectTrigger>
          <SelectContent>
            <SelectItem value="employee_statistics">人员统计</SelectItem>
            <SelectItem value="turnover_analysis">入离职分析</SelectItem>
            <SelectItem value="compensation_structure">薪酬结构</SelectItem>
          </SelectContent>
        </Select>
