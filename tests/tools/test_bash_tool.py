...
from boss_agent.tools.bash_tool import (
    BashTool,
    CommandFilter,
    DockerCommandFilter,
...
def test_successful_command():
    ...
    with patch("boss_agent.tools.bash_tool.run_command") as mock_run_command:
...
class BashToolTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.start_shell_patch = patch(
            "boss_agent.tools.bash_tool.start_persistent_shell",
            return_value=(self.mock_child, self.mock_prompt),
        )
        self.run_command_patch = patch(
            "boss_agent.tools.bash_tool.run_command",
    ...
    def test_create_bash_tool(self):
        ...
        with patch("boss_agent.tools.bash_tool.BashTool") as mock_bash_tool:
            _ = create_bash_tool(
...
class StartPersistentShellTest(unittest.TestCase):
    ...
    @patch("boss_agent.tools.bash_tool.pexpect.spawn")
